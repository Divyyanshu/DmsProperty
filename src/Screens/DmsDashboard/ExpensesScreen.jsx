...
const FieldLabel = ({ text, winW }) => (
  <View style={styles.fieldLabelRow}>
    ...
    <Text style={[styles.fieldLabelText, { fontSize: fs(11, winW) }]}>
      {text}
    </Text>
  </View>
);
  ...
  return (
    <View style={[styles.amtWrap, focused && styles.inputWrapFocused]}>
      ...
      <TextInput
        style={[
          styles.input,
          { paddingHorizontal: 12, fontSize: fs(13, winW) },
        ]}
            ...
            >
              ...
              {value === name && (
                <Text
                  style={[
                    styles.ddCheck,
                    { fontSize: fs(13, winW), flexShrink: 0 },
                  ]}
                >
                  ✓
                </Text>
...
const ExpenseModal = ({ visible, property, onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const expenseData = {
        Category: property?.badge === 'Farmhouse' ? 'Farmhouse' : 'Airbnb',
      ...
      <View style={styles.modalSheet}>
        ...
        <View style={[styles.modalHdr, { paddingHorizontal: hPad }]}>
          <View
            style={[
              styles.modalIconBox,
              { backgroundColor: property.iconBg, flexShrink: 0 },
            ]}
          >
            <Image
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            ...
            <Text style={[styles.modalSub, { fontSize: fs(11, winW) }]}>
              Add Expense
            </Text>
          </View>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text style={[styles.modalCloseX, { fontSize: fs(13, winW) }]}>
              ✕
            </Text>
          </TouchableOpacity>
        </View>
    ...
    <View style={[styles.catCard, { overflow: 'hidden' }]}>
      ...
      >
        <View
          style={[
            styles.catIconBox,
            { backgroundColor: '#fff', borderWidth: 1, flexShrink: 0 },
          ]}
        >
          <Image
        ...
        <View style={{ flex: 1, minWidth: 0 }}>
          ...
          <Text style={[styles.catSub, { fontSize: fs(11, winW) }]}>
            {category.sub}
          </Text>
        </View>
        <Text
          style={[
            styles.catArrow,
            { fontSize: fs(12, winW), flexShrink: 0 },
            expanded && styles.catArrowUp,
          ]}
        >
          ▼
        </Text>
          ...
          {category.properties.map((prop, i) => (
            ...
            >
              ...
              <Text
                ...
                style={[
                  styles.propName,
                  { flex: 1, minWidth: 0, fontSize: fs(13, winW) },
                ]}
              >
                {prop.label}
              </Text>
              <View style={[styles.propBadge, { flexShrink: 0 }]}>
                <Text
                  style={[styles.propBadgeText, { fontSize: fs(10, winW) }]}
                >
                  {prop.badge}
                </Text>
              </View>
              <Text
                style={[
                  styles.propChevron,
                  { fontSize: fs(20, winW), flexShrink: 0 },
                ]}
              >
                ›
              </Text>
