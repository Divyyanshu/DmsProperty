...
const ExpenseRow = ({ item, isLast }) => (
  <View style={[styles.expRow, !isLast && styles.expRowBorder]}>
    ...
    {/* CATEGORY */}
    <View style={[styles.expCatBadge, { backgroundColor: Colors.cat_teal_bg }]}>
      <Text style={[styles.expCatText, { color: Colors.cat_teal_text }]}>
        {item.Category}
      </Text>
    </View>

    {/* MIDDLE */}
    <View style={styles.expRowMid}>
...
const AirbnbExpenses = ({ visible, property, period, onClose }) => {
        ...
        <View style={styles.header}>
          ...
          <View style={styles.summaryStrip}>
            ...
            <View style={styles.stripItem}>
              <Text style={styles.stripLabel}>TYPE</Text>
              <Text style={styles.stripVal}>{property.badge}</Text>
              <Text style={styles.stripSub}>property</Text>
            </View>
          </View>
        </View>
